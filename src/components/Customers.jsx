  ...
  return (
    <section className="py-[100px] h-auto bg-[#F8F8FA]">
        ...
        <div className="flex flex-col md:flex-row gap-[50px] mx-auto">
            <div className="flex-1 flex justify-center md:mr-[100px]">
              <img src={chat_group} className="w-[100%] h-[100%] md:w-[90%] md:h-full" alt="video_call" />
            </div>
            <div className="flex-1 flex justify-center md:items-start flex-col">
              <h1 className="font-secondary font-semibold text-[#1B1C20] text-[28px] md:text-[48px] leading-[40px] md:leading-[56px] md:max-w-[460px]">Get direct orders from your customers</h1>
              <p className="mt-[22px] font-primary text-[18px] text-[#383A47] leading-[30px] md:w-[440px]">Create custom landing pages with Rareblocks that converts more visitors than any website. With lots of unique blocks easily build a page. There are many variations of passages of available. </p>

              <div className="flex flex-row justify-between mt-[65px] gap-6 flex-wrap">
